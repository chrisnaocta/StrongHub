...
class _RegisterPageAdminState extends State<RegisterPageAdmin> {
  ...
  bool _validateInput({
    ...
    if (!email.contains('@') || !email.contains('stronghub.com')) {
      setState(
        () => _message = "❌ Format email tidak valid! Gunakan email stronghub!",
      );
      return false;
    }
  ...
  /// 🔹 Proses Register ke Firebase untuk ADMIN
  Future<void> _register() async {
    ...
    final userId = await FirebaseRealtimeService.registerAdmin(
      name: name,
      email: email,
      phone: phone,
      password: password,
    ...
    if (userId != null) {
      ...
      ScaffoldMessenger.of(context).showSnackBar(
        SnackBar(
          content: Text('✅ Registrasi Admin berhasil sebagai ($userId)!'),
        ),
      );
